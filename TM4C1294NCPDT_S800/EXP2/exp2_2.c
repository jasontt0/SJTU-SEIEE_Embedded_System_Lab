...
void run(void)
{
	result = I2C0_WriteByte(TCA6424_I2CADDR, TCA6424_OUTPUT_PORT1, seg7[num]);		  // write port 1：段选，指定显示数字
	result = I2C0_WriteByte(TCA6424_I2CADDR, TCA6424_OUTPUT_PORT2, (uint8_t)(1)); // write port 2：片选，1号位
	result = I2C0_WriteByte(PCA9557_I2CADDR, PCA9557_OUTPUT, light[which_light]);　//点亮Led 1~8
